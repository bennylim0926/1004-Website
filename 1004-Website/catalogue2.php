...
<html lang="en">
    ...
    <body>
                    ...
                    if ($result1->num_rows > 0) {
                        while ($row = $result1->fetch_assoc()) {
                            ...
                            <article class="col-sm-4">
                                <div class="rounded product-img">
                                    <a href="/1004-Website/cart/product_page.php?id=<?php echo $row['id'] ?>">
                                        <img class="img-product" src="images/products/<?php echo $row['img'] ?>" alt="<?php echo $row['name'] ?>">
                                        <div class="card-body">
                                            <span class="image-name"><?php echo $row['name'] ?>
                                            </span>
                                    </a>
                                </div>    
                        </div>
        ...
        <div class="container-fluid padding">
            ...
            <div class="row text-center padding">
                <div class="col-12">
                    <h2 class="producttitle1">KEYBOARDS</h2>
                </div>
                <?php
//require_once('component.php');
                $config = parse_ini_file('/var/www/private/db-config.ini');
...
$sql2 = "SELECT * FROM ITshop.products where categoryid=1";
$result2 = $conn->query($sql2);
